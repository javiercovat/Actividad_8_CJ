...
public class deck_CJ {
    ...
    public static void head (ArrayList < Object > a) throws Exception {
        System.out.println(a.get(0).toString());
        a.remove(0);

        if (a.size()==0){ throw new Exception("Se han agotado las cartas");}

        System.out.println("Quedan " + a.size() + " cartas en la baraja.");
    }

    public static void pick (ArrayList < Object > a) throws Exception {
    ...
    public static void hand(ArrayList < Object > a) throws Exception {
        Random randomNumbers = new Random();
    ...
    public static void deck (ArrayList < Object > a) throws Exception {
